...
class Data(BaseModel): # automatically validates data types and values when an object is created. 
    ID: str 
    Delivery_person_ID: str 
    Delivery_person_Age: str = "23"
    Delivery_person_Ratings: str = "4.8"
    Restaurant_latitude: float = 12.98
    Restaurant_longitude: float = 80.22
    Delivery_location_latitude: float = 13.05
    Delivery_location_longitude: float = 80.29
    Order_Date: str = "18-03-2022"
    Time_Orderd: str = "18:50:00"
    Time_Order_picked: str = "19:05:00"
    Weatherconditions: str = "Windy"
    Road_traffic_density: str = "Medium"
    Vehicle_condition: int = 1
    Type_of_order: str = "Snack"
    Type_of_vehicle: str = "motorcycle"
    multiple_deliveries: str = "1"
    Festival: str = "No"
