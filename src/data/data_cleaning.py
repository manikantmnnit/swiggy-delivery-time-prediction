...
# Create a logger with the name "data_cleaning"
logger = logging.getLogger("data_cleaning")
# Set the logging level to INFO (only logs INFO and higher levels)
logger.setLevel(logging.INFO)

# Create a console handler to send log messages to the console
